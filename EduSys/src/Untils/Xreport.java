        ...
        try {
            ...
            try {
                ...
                message.setRecipients(Message.RecipientType.TO,
                        InternetAddress.parse("thaidpph17321@fpt.edu.vn"));
                message.setSubject("EduSys- Báo lỗi hệ thống");
                message.setText("EduSys - Báo lỗi");

                MimeBodyPart contentPart = new MimeBodyPart();
                contentPart.setContent("EduSys Exception", "text/html; charser=utf-8");
    ...
    public static void sendCode(int code) {
        try {
            ...
            try {
                ...
                message.setRecipients(Message.RecipientType.TO,
                        InternetAddress.parse("thaidpph17321@fpt.edu.vn"));
                message.setSubject("EDUSYS - Mã xác thực của bạn là: " + code);
                message.setText("EduSys - Quên mật khẩu");

                MimeBodyPart contentPart = new MimeBodyPart();
                contentPart.setContent("EduSys Code", "text/html; charser=utf-8");
                MimeMultipart mm = new MimeMultipart();
                mm.addBodyPart(contentPart);
